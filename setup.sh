...
deploy_workflow_skill "toolkit-update.md" "scott-toolkit-update" \
  ...
  Walks through 5 phases: Review Trigger, Identify Files, Draft Changes,
...
# Check skills
for skill in scott-new-project scott-resume scott-new-feature scott-retro scott-handoff scott-toolkit-update scott-log-success scott-log-error; do
