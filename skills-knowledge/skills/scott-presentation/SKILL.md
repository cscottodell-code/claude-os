---
name: scott:presentation
user_invocable: true
invocation_hint: /scott:presentation - Analyze and improve a presentation or story
description: >
  Analyze and improve presentations, stories, pitches, and narratives using Scott's
  Master Storytelling Framework. Use this skill whenever Scott shares a presentation,
  story, speech, pitch, talk outline, all-hands script, or narrative for review. Also
...
|---|---|
| **Story Structure** (Sec 1) | CART framework, 5 Pillars, Why Hierarchy, Transformation Arc |
| **Opening & Hooks** (Sec 2) | 7-Second Rule, SSS Protocol, Open Loops, Stakes |
| **Show Don't Tell** (Sec 3) | Camera Zoom, 5 Cognitive Questions, Dialogue, Sensory Anchors |
| **Vulnerability** (Sec 4) | Struggle present?, Relatability Gap, Pedestal Effect |
| **Language** (Sec 7) | 5th-grade readability, Sentence Fracturing, Anti-Preacher |
...
| Rating | Meaning |
|---|---|
| **Strong** | This dimension is working well. Minor polish only. |
...
|---|---|---|
| CART Structure | Strong / Needs Work / Missing | One-line explanation |
| Opening Hook | ... | ... |
| Show Don't Tell | ... | ... |
...
[2-3 sentences, word-for-word]

**Middle** (key scenes to walk through):
- Scene 1: [description]
- Scene 2: [description]
- Scene 3: [description]

**Closing** (memorize this):
[1-2 sentences, word-for-word]
...
- Any physical gestures or movements that would reinforce a moment
- Estimated time (target 60-120 seconds unless Scott specifies otherwise)
